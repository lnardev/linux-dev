...
## Gotchas
- The footer text `"22 categorías · generado para uso local · sin dependencias externas"` hardcodes the category count. If you add/remove a top-level category in `DATA`, update this number manually — it is NOT auto-computed.
